...
router.get('/blog', (req, res) => {
    // Simulación de blogs (puedes reemplazarlo por datos de base de datos)
    const blogs = [
        {
            titulo: 'Cómo hacer mantenimiento básico a tu moto',
            imagen: '/img/mantenimiento.webp',
            fecha: '2024-05-10',
            categoria: 'mantenimiento',
            extracto: 'Aprende a cuidar tu moto con estos consejos esenciales...',
            slug: 'mantenimiento-basico-moto'
        },
        {
            titulo: 'Las mejores motos urbanas de 2024',
            imagen: '/img/MOTOFONDO1.png',
            fecha: '2024-05-01',
            categoria: 'novedades',
            extracto: 'Te presentamos las mejores opciones para moverte en la ciudad...',
            slug: 'mejores-motos-urbanas-2024'
        }
    ];
